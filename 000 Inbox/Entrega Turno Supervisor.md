...
| Puesto | Nombre |
| --- | --- |
| Tablero de Crudos | Edwin Mauricio Pardo |
| Tablero de Aguas | Rodrigo Barney Reina |
| Operador Crudos | Carlos Gustavo Nossa |
| Operador Aguas | Daniel Morera Basto |
| Operador Despacho | Luisa Fernanda Hortúa |
| Operador de Apoyo | Cesar Alexander Sanmiguel |
| Operador Stap Portatil | Brayan Alejandro Quevedo |
| Custodio HSE | John Henry Reyes |
| Custodio OE | No hubo |

- Continuación de ejecución de curso en Success Factors sobre **Operación Estructurada**.
...
- Se continúa con mantener interfase del tanque ATK-7212 a válvula 10 para realizar el seguimiento del funcionamiento de la sonda Agar. Continuar con este requerimiento.
- Se suspende drenaje del tanque ATK-7208A hacia el sumidero, por presentarse altos niveles de sólidos y grasas en los CPI's del STAP1, se requiere realizar coordinación para el retiro del producto restante del tanque, según indicaciones por parte de la Ing. Andrea Guarín tratar como borras y enviar a los lechos de secado.
- Corroborar la necesidad de inyección de química hacia el tanque ATK-7206B y entrada a los CPI's del STAP1 para estabilizar los parámetros de sólidos y grasas generados por el drenaje reportado anteriormente.
...
- Se realiza reunión de inicio de turno.
- Se realiza sesión de análisis operacional donde se establecen objetivos de turno y se hace énfasis en comportamientos HSE.
...
Se realizó despacho del Fracktank 1 (380 Bbls 34 %BSW) al tanque ATK-7213.

**Proyectada a las 5:30 am**
31.570 Bbls

**Dato de producción 08-06-2021**

| Esperada | Producción | Diferencia |
| --- | --- | --- |
| 30.485 | 30.455 | -30 |
...
| --- | --- | --- | --- | --- | --- |
| ATK-7204A | 10 | 10 | 1.2 | 14.3 | 17.000 |
| ATK-7212 | 11 | 10 | 0.2 | 15.1 | 21.000 |
| ATK-7215 | FS | FS | FS | FS | FS |
| ATK-7204B | 13 | 13 | 22 | 13 | - |
| ATK-7205B | 13 | 14 | 26 | 13 | - |
| ATK-7206B | 15 | 15 | 4.4 | 13 | - |
...
| --- | --- | --- | --- | --- |
| Piscina 7 | 1.65 | - | 7 | 1.06 | %% LIT-7274/88 %%
| Estación Acacías | - | 56.600 | 23 | 13.50 | %% FIT-7217 %%
| PAD1 | - | 350.000 | 4 | 0.95 | %% FIC-7606 %%
| K1-K2 | - | 105.000 | - | - | %% FIT-7220 %%
| Estación Castilla 3 | - | 0 | - | - | %% FIT-7201A %%

**Crudos**
- 18:10 se alinea AP 7202E/F desde el ATK 7213 para tomar muestra de calidad y para bajar nivel del mismo.
- 22:00 se suspende despacho a San Fernando por llenado de botella toma muestra de autosampler.
- 23:00 se solicita a la EA1 suspender bombeo de crudo para iniciar recolección de muestras de liquidación.
- 23:59 no se realiza medición de tanque ATK-7210, ATK-7213 y ATK-7216 por condiciones climáticas.
- 00:05 inicia drenaje de condensados hacia el sumidero principal.
- 00:05 inicia recibos EC2/EA1 en ATK 7213.
- 00:10 se inicia despacho hacia san Fernando desde el ATK 7213.
- 00:35 Se aumenta recibo de nafta de 90 BPH a 150 BPH para aumentar existencias.
- 01:20 se alinean recibos al ATK 7213 para almacenar producto con Frac Tank #3. 
- 01:20 inicia despacho del Frac Tank #3 hacia el ATK 7213 para mezclar junto con el recibo del EA1, drenar e iniciar a despachar mezclado hacia San Fernando sin afectar calidad de despacho.
- 03:10 finaliza despacho del Frac Tank #3 se despachó con bomba AP 7203A directo al ATK 7213 sin pasar por el ATK 7209A.
- 03:25 finaliza almacenamiento de PNC de la EC2 en el ATK 7213. 
- 03:40 se abre 5.5%Valvula de salida del ATK 7213 para iniciar a despachar mezclado hacia San fernando.
- 04:25 se baja recibo de nafta de 150 BPH a 90 BPH.
- 05:00 se suspende drenaje del ATK 7208A, recomienda no drenar ese producto en la planta ni tampoco disponer en frac tank, se recomienda retirar de la planta con camión de vacío.

**Aguas**
- Se realiza retro lavado del sistema de filtración por buena calidad.
- Se realiza limpieza foso AFO-7267.
- 19:40 Operador de campo realiza cierre de 5 hilos a la salida de piscina 5.
- 00:00 ESF- inicia despacho de agua de 1000 bls de agua.
- 21:20 EA1 aumenta caudal de bombeo de agua por piscina 7 de 2000 BPH a 2500 BPH.
- Pozos pendientes de encendido por alto vertimiento. C209, C564 y C598.
...
- Personal de Confipetrol Electricidad realiza:
	- Se realiza mantenimiento preventivo de bomba AP-7255A/B.
